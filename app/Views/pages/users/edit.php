...
<div class="card rounded-0">
    ...
    <div class="card-body">
        <div class="container-fluid">
            <form action="<?= base_url('Main/user_edit/'.(isset($user['id'])? $user['id'] : '')) ?>" method="POST"  enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group rounded-0">
                        <input type="text" class="form-control rounded-0" id="name" name="name" autofocus placeholder="Nave" value="<?= !empty($user['name']) ? $user['name'] : '' ?>" required="required">
				...
				<div class="mb-3">
                    ...
                    <div class="input-group rounded-0">
						<textarea  class="form-control rounded-0" id="address" name="address" ><?= $user['address'] ?></textarea>
				...
				?>
                    <img width="100px" height="100px" src="<?php echo base_url() . '/writable/uploads/'.$imagename; ?>" alt="<?php echo $user['image']; ?>">					
               </div>
                </div>
				 </div>
				  </div>
